            ...
            <div class="app-card-body p-3 p-lg-4">
                ...
                <div class="row gx-5 gy-3">
                    <div class="col-12 col-lg-9">
                        ...
                        <div>Portal is designed to manage all Activities from one place. The design is simple, clean
                            and easy to use. </div>
                    </div>
    ...
    <div class="row g-4 mb-4">
        <div class="col-6 col-lg-3">
            <div class="app-card app-card-stat shadow-sm h-100">
                <div class="app-card-body p-3 p-lg-4">
                    <h4 class="stats-type mb-1">Farmers Forms</h4>
                    <div class="stats-figure">{{ $farmers->count() }}</div>
        ...
        <div class="col-6 col-lg-3">
            <div class="app-card app-card-stat shadow-sm h-100">
                <div class="app-card-body p-3 p-lg-4">
                    <h4 class="stats-type mb-1">Customer Forms</h4>
                    <div class="stats-figure">{{ $customers->count() }}</div>
                    {{-- <div class="stats-meta text-success">
        ...
        <div class="col-6 col-lg-3">
            <div class="app-card app-card-stat shadow-sm h-100">
                <div class="app-card-body p-3 p-lg-4">
                    ...
                    <div class="stats-figure">{{ $products->count() }}</div>
        ...
        <div class="col-6 col-lg-3">
            <div class="app-card app-card-stat shadow-sm h-100">
                <div class="app-card-body p-3 p-lg-4">
                    <h4 class="stats-type mb-1">Total Recipies</h4>
                    <div class="stats-figure">{{ $recipies->count() }}</div>
        ...
        <div class="col-12 col-lg-4">
            <div class="app-card app-card-basic d-flex flex-column align-items-start shadow-sm">
                ...
                <div class="app-card-body px-4">
                    ...
                    <div class="intro">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam aliquet eros vel
                        diam semper mollis.</div>
                </div><!--//app-card-body-->
        ...
        <div class="col-12 col-lg-4">
            <div class="app-card app-card-basic d-flex flex-column align-items-start shadow-sm">
                ...
                <div class="app-card-body px-4">
                    ...
                    <div class="intro">Pellentesque varius, elit vel volutpat sollicitudin, lacus quam efficitur augue
                    </div>
                </div><!--//app-card-body-->
                <div class="app-card-footer p-4 mt-auto">
                    <a class="btn app-btn-secondary" href="#">Create New</a>
