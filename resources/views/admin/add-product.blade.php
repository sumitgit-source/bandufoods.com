...
@section('content')
    ...
    <form class="row g-4 mb-4" action="{{ route('saveProduct') }}" method="POST" enctype="multipart/form-data">
        <div class="col-12 col-lg-6">
            <div class="card shadow-sm border-0 h-100 p-3">
                ...
                <div class="app-card-body px-2 py-2">
                    ...
                    <input type="text" name="title" value="{{ old('title') }}" placeholder="Product Name" class="form-control">
                    @error('title')
                ...
                <div class="app-card-body px-2 py-2">
                    ...
                    <input type="text" name="info" value="{{ old('info') }}" placeholder="Product Detail" class="form-control">
                    @error('info')
                        <div style="color: red;">{{ $message }}</div>
                    @enderror
                </div>
                <div class="app-card-body px-2 py-2">
                    ...
                    <textarea class="form-control" name="description" value="{{ old('description') }}" placeholder="Product Description" rows="10" style="height: 100px"></textarea>
                    @error('description')
                        <div style="color: red;">{{ $message }}</div>
                    @enderror
                </div>
